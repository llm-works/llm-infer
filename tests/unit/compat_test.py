...
class TestGetSupportedModelTypes:
    ...
    def test_includes_default_types(self) -> None:
    ...
    def test_includes_registered_architectures(self) -> None:
...
class TestValidateSpec:
    ...
    def test_valid_spec_minimal_issues(self) -> None:
...
class TestCheckSpecAccuracy:
    ...
    def test_returns_tuple(self) -> None:
        ...
        valid, issues = check_spec_accuracy()
        assert isinstance(valid, bool)
        assert isinstance(issues, list)

    def test_with_nonexistent_file(self) -> None:
        """Test with nonexistent spec file."""
        valid, issues = check_spec_accuracy(spec_file="/nonexistent/file.yaml")
...
class TestValidateSpecExtraTypes:
    ...
    def test_extra_model_types(self) -> None:
    ...
    def test_missing_model_types(self) -> None:
